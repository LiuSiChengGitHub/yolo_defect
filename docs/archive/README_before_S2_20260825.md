...
External reviewers or web-based GPT tools should start with the branch-aware [repository reading guide](docs/WEB_GPT_REPOSITORY_GUIDE.md). It gives a compact reading order, separates the engineering workflow from the model Runtime, and prevents historical Python, current C++, and planned research evidence from being mixed.
